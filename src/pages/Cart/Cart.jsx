...
import { addToCart, removeFromCart, removeProduct } from '../../redux/cart/cartAction';
                            ...
                            props.products.map(product => {
                                return <div className="d-flex justify-content-between align-items-center text-center" key={product.id}>
                                    ...
                                    <div className="d-flex w-25 justify-content-center">
                                        <Minus onClick={() => {props.removeProduct(product)}}/>
                                        <p className="w-25">{ product.quantity }</p>
                                        <Plus onClick={() => {props.addProduct({product: product})}}/>
                                    </div>
